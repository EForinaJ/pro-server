...
func (c *ControllerV1) GetWechatPay(ctx context.Context, req *v1.GetWechatPayReq) (res *v1.GetWechatPayRes, err error) {
	options, err := service.System().GetOne(ctx, consts.WechatPaySetting)
	if err != nil {
