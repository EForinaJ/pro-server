...
func (c *ControllerV1) GetContact(ctx context.Context, req *v1.GetContactReq) (res *v1.GetContactRes, err error) {
	options, err := service.System().GetOne(ctx, consts.ContactSetting)
	if err != nil {
